...
export default {
	...
	theme: {
		...
		extend: {
            ...
            boxShadow: {
                'neon-cyan': '0 0 5px 2px rgba(14, 165, 233, 0.3), 0 0 8px 4px rgba(14, 165, 233, 0.2)',
                'neon-purple': '0 0 5px 2px rgba(147, 51, 234, 0.3), 0 0 8px 4px rgba(147, 51, 234, 0.2)',
                'neon-magenta': '0 0 5px 2px rgba(219, 39, 119, 0.3), 0 0 8px 4px rgba(219, 39, 119, 0.2)',
			...
			keyframes: {
                ...
                'glow': {
                    '0%, 100%': { boxShadow: '0 0 5px rgba(14, 165, 233, 0.3), 0 0 8px rgba(14, 165, 233, 0.2)' },
                    '50%': { boxShadow: '0 0 15px rgba(14, 165, 233, 0.5), 0 0 20px rgba(14, 165, 233, 0.3)' },
                },
			},
			animation: {
